...
<?php if (file_exists($conservationPlot)): ?>
    ...
    <p><a href="<?php echo $conservationPlot; ?>" class="menu-button" download>Download Conservation Plot</a></p>
<?php else: ?>
    <p style="color:red;">Conservation plot not found.</p>
<?php endif; ?>
<p><a href="interactive_alignment.php" class="menu-button">Return to Alignment</a></p>
