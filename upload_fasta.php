...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_FILES['fasta_file'])) {
    ...
    if ($file_type !== 'fasta' && $file_type !== 'fa' && $file_type !== 'txt') {
        echo "<p style='color:red;'>❌ Please upload a valid FASTA file (.fasta, .fa)</p>";
        ...
        echo "<p><a class='menu-button' href='$target_file' download>📥 Download your uploaded file</a></p>";
