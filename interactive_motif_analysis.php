...
<?php if (file_exists($motifReport)): ?>
    ...
    <p><a href="<?php echo $motifReport; ?>" class="button-link" download>Download Motif Analysis Report</a></p>
<?php else: ?>
    <p style="color:red;">Motif analysis report not found.</p>
<?php endif; ?>
<p><a href="interactive_tutorial.php" class="button-link">Return to Tutorial</a></p>
